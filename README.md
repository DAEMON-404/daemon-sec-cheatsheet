...
| --- | --- | --- |
| `src/content/payloads/` | [PayloadsAllTheThings](https://github.com/swisskyrepo/PayloadsAllTheThings) (Swissky) | MIT, Copyright (c) 2019 Swissky — see `vendor/PayloadsAllTheThings/LICENSE` |
| `src/content/internal/` | [InternalAllTheThings](https://github.com/swisskyrepo/InternalAllTheThings) (Swissky) | none published upstream; copyright stays with Swissky and its contributors |
...
The site's own code and hand-written cheatsheets are licensed under
[MIT](./LICENSE). That licence does not extend to the mirrored trees above.
