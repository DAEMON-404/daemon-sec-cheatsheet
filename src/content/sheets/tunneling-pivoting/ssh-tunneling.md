...
description: "SSH local/remote/dynamic forwarding and Metasploit route/portfwd pivoting, worked end to end."
category: tunneling-pivoting
tags: [pivoting, ssh, port-forwarding]
tools: [SSH, Metasploit]
...
I'll do a deep research on SSH tunneling with Metasploit, specifically using the Pandora HTB box as a practical example to clarify the correct approach.
