...
updated: "2026-08-10"
source: "vault:ActiveDirectory/SharpHound_Cheatsheet.md"
---
...
## SharpHound.ps1
```powershell
# After uploading SharpHound.ps1:
Import-Module .\SharpHound.ps1
Invoke-BloodHound -CollectionMethod All -Domain htb.local -DomainController 10.129.15.16 -LDAPUser svc-alfresco -LDAPPass s3rvice
```
