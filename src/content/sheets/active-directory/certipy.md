...
difficulty: advanced
updated: "2026-08-09"
source: "repo:Active-Directory/Certipy-ad.md"
---
...
> **Note —** The package installs as `certipy-ad`; on many builds the invoked binary is `certipy`. Commands below use `certipy-ad` as written — substitute `certipy` if that is what your install exposes.
